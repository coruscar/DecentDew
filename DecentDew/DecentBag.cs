...
namespace DecentDew
{
    public class DecentBag : Mod, ISaveElement
    {
        ...
        {
            texture = ModEntry._helper.Content.Load<Texture2D>(@"Assets/seedbag.png");
            attTexture = ModEntry._helper.Content.Load<Texture2D>(@"Assets/seedattachment.png");
            att2Texture = ModEntry._helper.Content.Load<Texture2D>(@"Assets/fertilizerattachment.png");
        }
        ...
        public override string DisplayName { get => "Bee Bag"; set => base.DisplayName = "Bee Bag"; }
